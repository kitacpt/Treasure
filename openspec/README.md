...
- 0006 · 真 schema migration（v1→v4 全部，MigrationTest）+ 拍照 / 多选照片
- 0007 · AI 生成博物馆插画 + callout 文字标注 + OpenAI / 自定义 provider
- 0008 · 全屏看图浏览器 + 多轮 AI 对话
- 0009 · FastAPI 同步层 + 后端 admin + 真实照片云端备份

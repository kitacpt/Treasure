...
**cycle 0001 → 0020 全部落地。**

- APK：`android/app/build/outputs/apk/debug/app-debug.apk` （v0.20.0 候选，13 MB，debug 签名）
- GitHub：<https://github.com/kitacpt/Treasure>（main 分支；cycle 0009-0020 改动尚未 push，下次 commit 之后更新）
...
8. [`openspec/`](openspec/) — cycle 0001-0020 提案 / 规格 / 笔记
...
3. **AI 生成博物馆插画**
4. **Settings preset 校准** — Xiaomi MiLM 没公开端点
5. **MigrationTest CI**
6. **PageFetcher 进阶**：抓不到 SSR 时 fall back 到 minimal headless WebView 渲染拿 DOM

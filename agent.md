...
15. **录入页参考实测**：cycle 0036 三块 OTA + v2 修补刚落地，需在 vivo X200 Pro mini 上跑 smoke：CREATE/MODIFY × 有图/无图 × 单卡/多卡 4×2 矩阵 + 文件喂 PDF/JSON + 删会话后 `adb shell ls /data/data/com.treasure/files/` 验证清理
